...
En la gráfica se muestra una clara diferencia entre las clases alta, media y baja si hablamos de calidad de vida global, con las comunidades de clase alta manteniéndose en niveles considerablemente superiores a lo largo del tiempo y manteniendose estables durante los años. Las comunidades de clase media también parecen constantes aunque a partir de 2010 parecen tener un decaimiento. Finalmente, la clase baja parece tener mayor variabilidad en sus valores con caídas notables alrededor de 2016. 
HACER BOXPLOT DE CADA CLASE SE ME OCURRE
