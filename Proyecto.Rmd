...
spain_map <- spain_map %>%
  mutate(color = case_when(
    clase == "Alta" ~ "blue",   # Clase alta en azul
    clase == "Media" ~ "red",   # Clase media en rojo
...
ggplot(data = spain_map) +
  ...
  scale_fill_manual(
    values = c(
      "Alta" = "blue",   # Clase alta en azul
      "Media" = "red",   # Clase media en rojo
      "Baja" = "green"   # Clase baja en verde
    ),
...
```
En la gráfica superior podemos ver la distribución geográfica de las clases sociales en España. Podemos ver que la distribución es prácticamente homogénea. La clase alta se distribuye en el norte de España, excepto en Cataluña y Galicia. La clase media reside alrededor del centro de la península y la clase baja se ubica en el sur de la península, las Islas Canarias y Galicia. Este mapa indica que la calidad de vida aumenta cuanto más al norte de España nos ubiquemos.
