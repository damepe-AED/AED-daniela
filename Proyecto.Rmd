...
```{r}
plot_boxplot <- ggplot(dim_all, aes(x = factor(Anio), y = Valor_Global, fill = Cluster)) +
  geom_boxplot(alpha = 0.7, outlier.color = "red", outlier.shape = 16) +
  labs(
    title = "Distribución de Valor Global por Año y Clase",
    x = "Año",
    y = "Valor Global",
    fill = "Clase"
  ) +
...
```{r}
plot_boxplot_outliers <- ggplot(dim_all, aes(x = factor(Anio), y = Valor_Global, fill = Cluster)) +
  ...
  labs(
    title = "Boxplots con Outliers Coloreados por Clase",
    x = "Año",
    y = "Valor Global",
    fill = "Clase (Boxplot)",
...
Observando la gráfica anterior, observamos que hay algunos valores extremos a lo largo del tiempo presentes en las agrupaciones. Relacionando estas observaciones con la gráfica general, identificamos que los valores extremos superiores de la clase alta pertenecen a la Comunidad Foral de Navarra; los valores extremos superiores de la clase baja pertenecen a Galicia; y los valores extremos inferiores de la clase baja pertenecen a Ceuta. [POR DESARROLLAR]
